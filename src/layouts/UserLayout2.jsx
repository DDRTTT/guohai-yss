...
import prospectuSetBg from '@/assets/login/prospectuSet_bg.png';
  ...
  return (
    <>
      <div className={styles.container}>
        <div style={{ backgroundColor: '#005BAC', width: '100%', height: '100vh', position: 'absolute' }}>
          <img
            src={prospectuSetBg}
            style={{ position: 'absolute', right: '50%', top: '50%', marginRight: '-180px', marginTop: '-260px'  }}
          />
        </div>
