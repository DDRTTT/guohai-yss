...
// 获取产品类树
export const GET_PRO_TREE_API: string = `${aProduct}/product/getauthorizprotypetree`;

// 获取我的产品分组
export const GET_PRO_GROUP_API: string = `${yAdmin}/productgroup/getprogroup`;

// 条件查询产品-分页
export const GET_PRO_PAGINATION_API: string = `${yAdmin}/userproduct/selectpro`;
...
// 便捷授权保存
export const SAVE_QUICK_AUTH_API: string = `${yAdmin}/role/setAuth?quickFlag=1`;

// 便捷授权详情
export const QUICK_AUTH_DETAIL_API: string = `${yAdmin}/userproduct/getuserauthed?quickFlag=1`;
