...
export function getTableDataList(params) {
  return request(`${uri}/bondTradeDeviateReportWeekly/tasklist/search`, {
    method: 'POST',
    data: params,
  });
}
...
export async function getDeleteAPI(params) {
  return request(`${uri}/bondTradeDeviateReportWeekly/delete?id=${params}`)
...
export const getBatchSubmitByProCodeApi = params =>
  request(`${uri}/bondTradeDeviateReportWeekly/batchCommit`, {
    method: 'POST',
    data: params,
  });
