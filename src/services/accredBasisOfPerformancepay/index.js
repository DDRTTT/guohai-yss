...
export async function getListAPI(params) {
    return request(`${url}/amsAccruedAgreement/taskList`, {
        method: 'POST',
        data: params,
    });
}
...
export async function getDeleteAPI(params) {
    return request(`${url}/amsAccruedAgreement/delete/batch`, {
        method: 'POST',
        data: params,
    });
}
...
export function batchCommit(data) {
    return request.post(`${uri}/amsAccruedAgreement/commit/batch`, {
        data,
    });
}
