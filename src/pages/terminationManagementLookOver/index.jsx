...
import FormTable from '../../components/addInfomation/terminationLookOverTable';
      ...
      <div>
        ...
        <div className={style.topHeader}>
          <div className={style.topHeaderL}>
            <span className={style.topTitle}>查看详情</span>
          </div>
        ...
        <div className={style.information}>
          ...
          <div className={style.mianBox}>
            <div className={style.mianList}>
              <label>终止日期:</label>
              <Select defaultValue="终止日期" className={style.mianSelect} onChange={handleSelect}>
                <Option value="jack">Jack</Option>
                <Option value="lucy">Lucy</Option>
                <Option value="disabled" disabled>
                  Disabled
