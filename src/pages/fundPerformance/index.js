...
const Index = (props)=>{
  ...
  const handleCanCheck = record => {
    return router.push(
      `/dynamicPage/pages/基金业绩/4028e9c17f76cf7c017f901170fc0009/查看?type=view&id=${record.id}&secondary=true`
    );
  }
  // 新增
  const handleAdd = (record) => {
    return router.push(`/dynamicPage/pages/基金业绩/4028e9c17f76cf7c017f89af312e0000/新增?secondary=true`);
  };
  // 修改
  const handleCanUpdate = record => {
    return router.push(`/dynamicPage/pages/基金业绩/4028e9c17f76cf7c017fcda94e090015/修改?id=${record.id}&secondary=true`)
  };
  // 删除
