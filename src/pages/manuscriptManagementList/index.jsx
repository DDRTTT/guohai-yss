...
class Agent extends Component {
  ...
  handleBackPage() {
    ...
    this.props.dispatch(
      routerRedux.push({
        pathname: '/manuscriptSystem/manuscriptManagement',
        query: { type },
      }),
    );
  }
  ...
  render() {
    ...
    const columns = [
      ...
      },
      {
        ...
        sorter: true,
        render: (text, record) => (
          <Action code="manuscriptManagement:getFileHistory">
        ...
        render: (text, record) => {
          return (
            <>
              ...
              <Action code="manuscriptManagement:updateHandle">
...
const manuscriptManagementList = errorBoundary(
  linkHoc()(
    Form.create()(
      connect(
        ({
          ...
          const fileTableLoading =
            loading.effects['manuscriptManagementList/handleQueryTableReq'] ||
            loading.effects['manuscriptManagementList/getUpdateUseSealFilePreInspectReq'] ||
            loading.effects['uploadSection/getFilecutuploadReq'] ||
            loading.effects['manuscriptManagementList/getUpdateUseSealFileRegisterReq'];
...
export default manuscriptManagementList;
