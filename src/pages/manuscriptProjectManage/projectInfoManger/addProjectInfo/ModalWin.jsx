...
class ModalWin extends React.Component {
  constructor(props) {
    super(props);
    const { visible, denominator } = this.props;
    const { clientWidth, clientHeight } = document.documentElement;
    this.state = {
      visible: visible !== '' && visible !== null ? visible : false,
      clientWidth,
      clientHeight,
      pageX: clientWidth / (denominator || 3),
      pageY: '10vh',
      moving: false,
    };
  }
    ...
    const modal = (
      ...
      >
        ...
        >
          ...
          <div
            className={
              resetContentHeight ? styles.reset_custom_modal_content : styles.custom_modal_content
            }
          >
            {children}
          </div>
...
ModalWin.propTypes = {
  ...
  resetContentHeight: PropTypes.bool,
