...
import { Switch, Button, Modal, Form } from 'antd';
  ...
  render() {
    ...
    return (
      <div className={styles.content}>
        ...
        >
          <Form className={styles.addForm} {...this.layout} style={{ overflow: 'hidden' }}>
...
export default Form.create()(connect(Index)(index));
