const getTableData = (req, res) => {
  const data = {
    ...
    data: {
      ...
      rows: [
        {
          processInstanceId: 'b4a751a5-c347-11ea-91e7-0a580a2a0a011',
        ...
        {
          processInstanceId: '98f48fe3-c347-11ea-91e7-0a580a2a0a012',
          processDefinitionId: '37bd121b-c2ad-11ea-a703-0a580a2a0a01',
        ...
        },
        {
          ...
          processInstanceId: '3ec4d566-c038-11ea-88d4-0a580a2a0a013',
...
// 产品募集期调整 列表（搜索）
export default {
  'POST /ams/baseAccount/query/taskListByTab': getTableData,
  'GET /ams/baseAccount/query/dropdown': getAccountList,
  'GET /ams/ams-base-product/product/getProductList': getProductList,
};
